...
export const companywiseExperience = {
    'butterfly': {
        ...
        'responsibilities': [
            ...
            'Entire maintenance of the Plant ,process machinery and utilities – AHU, Chillier, ETP, compressor, etc',
    ...
    'mothers': {
        'designation': 'GM Operation and Projects(Technical)',
    ...
    'dukes': {
        ...
        'responsibilities': [
            ...
            'Responsible for up keep of the plant and machinery – Equipments and Utilities',
            'Responsible for BRC/ISO 22000 Standard factory maintenance, HACCP,GMP,GHP,TQM implementation',
            'Implementation of JIT and MRP for the cost effective manufacturing and inventory control'
        ]
    },
    'nilons': {
        'designation': 'Head (Operations) for the N.E. region',
        'duration': 'Null',
        'responsibilities': [
            ...
            'Rolled out new product ‘RTS beverage’ by handled product development to marketing.',
    ...
    'newby': {
        ...
        'responsibilities': [
            ...
            '‘A’ grade certificate for the factory in BRC and 90% in ISO 22000:2005 within 6 months.',
...
export const projects = [
    {
        id: 1,
        name: 'Green Field Project Management (FMCG Food)',
        details: [
            'Green field project executed - 300000 sq ft, 280000 sq ft, 50000 sq ft ,100cr, 80 cr and 25 cr respectively.',
            'planning and scheduling of the project',
            'Good experience in DPR formulation, project lay out/plant layout in line with ISO 22000,BRC requirements',
            'Finalization and Design of Project site lay out',
            'Plant and machinery layout includes utility layout',
            'Obtain the best supplier base ,use of internal and external resources',
            'Tracking activity against project plan',
            'Monitoring budgets vs. actual expenditure',
            'Maintaining and completing  project key performance indicator',
            'Organizing and facilitating the project  meeting',
            'Utility capacity analysis as per the plan/ budget and selection of vendors and finalization etc',
            'Client progress meeting on and off site, cost control, invoicing, variation claims, invoice payment resolution and condition of contract .Worked closely with other departments to promote overall effectiveness',
            'Executed 4 number green field project for FM CG food as GM project.',
            'Experienced in project utility ,machinery procuring for FMCG –Food industries',
            'Good practical knowledge in 33 KVA, 11 KVA HT line yard design, LT substation panel board design, capacitor bank , LT distribution system to sections( end point), internal power line lay out etc',
            'Capital goods machinery selection, negotiation considering technical aspects and productivity, ROI calculation.',
            'Project cost variance analysis with reasons',
            'Project-Internal external drainage system, water recirculation system, Solid waste disposal system',
            'ETP of 200000 capacity lay out and execution, Water treatment plant of 50000 lit/hr 50000lit/hr RO plant',
            'Multiple compressor of capacity 150HP commissioning',
            'Fire hydrants, fire fighting equipment for 3lacs carpet area plant, and commissioned in 5 no of plants.',
        ]
    },
    {
        id: 2,
        name: 'Ready To Eat',
        details: [
            'Started 3 lines (4 trolley x 3 no autoclave retort )- 300 tons/ month capacity',
            'Manufacturing process- The Vegetables, leaf vegetables cleaning, Peeling, blanching, Pulverizing, Cooking, cooling, Packing, Retorting, KMG international Retort operation, its utility and Lee pack auto retort pouch packing machine operations etc.',
            'Products- Aaloo motar, mix vegetables, motor paneer, palak paneer, payasam, Navaratna kurma etc'
        ]
    },
    {
        id: 3,
        name: 'Ready To Cook',
        details: [
            '400 tons/ months capacity installed and commissioned',
            'Manufacturing process and packaging for poha, upma, gravy –different variety, chutney'
        ]
    },
    {
        id: 4,
        name: 'Paste',
        details: [
            'Ginger, Garlic, Tamarind, Chutney of different variety.', 
            '1000 tons/ month capacity installed and commissioned automated system -Receiving, cleaning, sorting, de podding, grading, segregating, washing, grinding, blending for paste manufacturing, Raw garlic clove peeling etc – automated lines'
        ]
    },
    {
        id: 5,
        name: 'Sauce',
        details: [
            '700 tons capacity machinery installed and commissioned- automated lines',
            '(Chilli, Soya, Tomato ketchup , snack sauce, ,8-8 sauces, Vinegar etc ) recipe development and manufacturing process( by pulping, pulverizing, pasteurizing, cooking, homogenising, and its automatic glass and pet bottling, packaging Line.'
        ]
    },
    {
        id: 6,
        ...
        details: [
            ...
            'Good knowledge in HAAS-Austria, Forma Makina- Turkey- ovens, Arc an &amp; HAAS enrober, book cooler, Wafer cutter-Forma Makina &amp; Gocmen Sheet cooler, Gocmen cream spreader, wafer stick ovens-Masima, Indonesia. packing machines from china/India.',
            'Batter making, cream making, book cooling, cutting, enrobing and packaging, wafer rolls manufacturing ,its cooling and packing).'
        ]
    },
    {
        id: 7,
        name: 'Milk Chocolate/Compound',
        details: [
            'Mixing, Refining, concheing , molding , shell molding, one shot molding, Packaging, using imported machines from Aasted, Memak, Buhler , Netzsch ball mill etc'
        ]
    },
    {
        id: 8,
        name: 'Beverages',
        details: [
            'experience in RTS, juice line, liquid pet/ glass bottling line, Squash) – capacity installed and commissioned -1000 tons/month-',
            'Good practical experience in auto bottling line, capping, labelling, deaeration, pasteurization, carbonation, blending, filter press, and the juice manufacturing and squash manufacturing line.',
            'Ready to serve beverages: Mango drinks, Lime drinks, litchi drinks, etc manufacturing process, Packaged drinking water, Pasteurizing, deaeration system, blending and carbonation system, bottling, filter press etc. Squash recipe development and manufacturing process.',
            'Handled entire juice manufacturing, bottling line - consists of BOTTLING LINE. CAPING, LABELING,PACKING –Entire line.'
        ]
    },
    {
        id: 9,
        name: 'PET Bottle Moulding',
        details: [
            'PET bottle moulding, pre form –moulding machine operation'
        ]
    },
    {
        id: 10,
        name: 'Tea',
        details: [
            'Handled blending, packing capacity -50000 tons/year',
            'Manufacturing at Gardens, blending of teas, flavouring of teas, Packaging of teas, Tea bags manufacturing and packaging'
        ]
    },
    {
        id: 11,
        name: 'Pickles',
        details: [
            'Handled, installed, commissioned -10000 tons/year its recipe development and its manufacturing process by fruit washing, cutting, mixing and its bottling, packaging.'
        ]
    },
    {
        id: 12,
    ...
    },
    {
        ...
        name: 'Canning',
        details: [
            'Canning line-pineapple ,gherkin, etc'
        ]
    },
    {
        id: 14,
...
export const equipmentExposure = [
    ...
    {
        id: 4,
        name: 'Chocolate Manufacturing Line',
        image: 'profile.png',
        details: [
            'Project 5'
        ]
...
export const AboutMeDetails = [
    {
        id: '01',
        desc: 'A Mechanical Engineer with 30 years of experience in FMCG–Food, manufacturing, Production planning and control, Operations, Maintenance, Project Execution, Financial Management, Quality Assurance, and Cost Reduction.'
    },
    {
        id: '02',
        desc: 'Handled  food processing plant manufacturing capacity  of  30000 tons per year  and 50000 tons capacity.'
    },
    {
        id: '03',
        desc: 'Executed 5 no of green filed FMCG-Food project 280000 sq ft carpet area, 300000 sq ft carpet area projects.'
    },
    {
        id: '04',
        desc: 'Exhibited excellence by directing & executing operations of 4 manufacturing facilities (Kolkota, Gujarat, Karnataka of turn over 1000 cr.'
    },
    {
        id: '05',
        desc: 'Excellent understanding and practically handled the  ISO22000, BRC, HACCP, JIT-MRP ,TQM, system, GMP, GHP, TQM, KAIZEN as well as SOP preparations. FSSI Rules'
    },
    {
        id: '06',
        desc: 'Strategic Planner & Implementer with experience in directing the functioning of Production &   Manufacturing processes while focusing on profitability, quality, safety, cost, customer satisfaction and delivery functions by ensuring optimal utilization of resource.'
    }
]
