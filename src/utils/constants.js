...
export const companywiseExperience = {
    ...
    'newby': {
        'designation': 'Senior Manager – Operations & Project',
...
export const projects = [
    {
        ...
        details: {
                productsHandled: [
                    'Aalo Matar, Navaratna Kurma, Matar paneer, Suji Halwa, Mix Vegetables, Methi Matar,Palak Paneer, Samosa, parotha etc UPMA, POHA, Payasm , Gravy – Mix Veg gravy, Aalo motar gravy, paneer motar gravy, Butter chicken gravy etc'
                ],
                quantityHandled: [
        ...
        },
        {
            ...
            details: {
                ...
                quantityHandled: [
                    ...
                    'Tamarind Paste – 5tons/day ,From tamarind sorting to Tamarind paste manufacturing and bulk storage.',
        ...
        },
        {
            ...
            details: {
                ...
                quantityHandled: [
                    ...
                    'Semi finish product -Storage - Mango tukudi upto 3000 tons/year, Carrot- 2500 tons/ year, lime – 3000 tons/year'
                ],
                manufacturingProcess: [
                ...
                equipmentHandled: [
                    ...
                    'Automated bottle filling machine – 10000 bottles/day, auto measured oil toping machine ,automated labelling machine -100 labels/min and secondary packing'
                ],
                utilityRequired: [
                    'Boiler, Compressor, power -3 phase, RO plant ,Water treatment Plant , ETP, Waste disposal system'
                ]
        ...
        },
        {
            ...
            projectHighlight: [
                'Handled as a project Head for 30000 tons/year capacity state of art chocolate and wafer plant worth 100 cr –   State of Art Green field project-GMP,BRC certified'
            ],
            details: {
                productsHandled: [
        ...
        },
        {
            ...
            details: {
                ...
                manufacturingProcess: [
                    ...
                    'Instead auto claving , pasteurizing – automated system  can be done ,It is the process for glass bottling and can of different sizes',  
        ...
        },
        {
            ...
            details: {
                ...
                exposureInTea: [
                    ...
                    'Blending – 80000 tons /year  of  tea blending with blender  capacity  5tons/ batch – 4 nos', 
...
export const equipmentExposure = [
    ...
    },
    {
        ...
        details: [
            ...
            'Metal detector',
            'Automated bottle filling machine – 10000 bottles/day', 
